...
BEGIN
  ...
  player2_id := get_worker_user_id('TestPlayer2', 0);
  player3_id := get_worker_user_id('TestPlayer3', 0);
  ...
  RAISE NOTICE 'Player-to-Audience fixture created: Game #% (worker 0)', game_id;
END $$;

SELECT 'E2E Player-to-Audience fixture (worker 0) created successfully!' AS message;
