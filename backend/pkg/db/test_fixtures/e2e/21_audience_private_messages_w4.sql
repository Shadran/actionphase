-- E2E Test Fixture: Audience Private Messages View (Worker 4)
-- Game #40360, conversations 49960/49961

BEGIN;

DELETE FROM games WHERE id = 40360;
...
BEGIN
  ...
  INSERT INTO game_participants (game_id, user_id, role, status, joined_at) VALUES
    (40360, p1_id,  'player',   'active', NOW() - INTERVAL '4 days'),
    (40360, p2_id,  'player',   'active', NOW() - INTERVAL '4 days'),
    (40360, aud_id, 'audience', 'active', NOW() - INTERVAL '4 days');
  ...
  VALUES (40360, 'common_room', 1, 'Current Phase', 'Active phase', NOW() - INTERVAL '1 hour', NOW() + INTERVAL '23 hours', true, false, NOW() - INTERVAL '1 hour')
  RETURNING id INTO phase_id;

  INSERT INTO characters (game_id, user_id, name, character_type, status, created_at, updated_at)
  VALUES (40360, p1_id, 'Audience Test Char 1', 'player_character', 'approved', NOW() - INTERVAL '4 days', NOW())
  RETURNING id INTO char1_id;

  INSERT INTO characters (game_id, user_id, name, character_type, status, created_at, updated_at)
  VALUES (40360, p2_id, 'Audience Test Char 2', 'player_character', 'approved', NOW() - INTERVAL '4 days', NOW())
  ...
  VALUES (49960, 40360, 'Audience Test Conversation', 'direct', p1_id, NOW() - INTERVAL '30 minutes')
  ...
  INSERT INTO conversation_participants (conversation_id, user_id, character_id, joined_at) VALUES
    (49960, p1_id, char1_id, NOW() - INTERVAL '30 minutes'),
    (49960, p2_id, char2_id, NOW() - INTERVAL '30 minutes')
  ...
  VALUES
    (139601, 49960, p1_id, char1_id, 'First message from Player 1',  NOW() - INTERVAL '25 minutes', false),
    (139602, 49960, p1_id, char1_id, 'Second message from Player 1', NOW() - INTERVAL '24 minutes', false),
    (139603, 49960, p2_id, char2_id, 'Player 2 reply',               NOW() - INTERVAL '20 minutes', false)
  ON CONFLICT (id) DO UPDATE SET content = EXCLUDED.content;

  -- Conversation 2: last message preview test
  INSERT INTO conversations (id, game_id, title, conversation_type, created_by_user_id, created_at)
  VALUES (49961, 40360, 'Preview Test Conversation', 'direct', p1_id, NOW() - INTERVAL '15 minutes')
  ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, game_id = EXCLUDED.game_id;

  INSERT INTO conversation_participants (conversation_id, user_id, character_id, joined_at) VALUES
    (49961, p1_id, char1_id, NOW() - INTERVAL '15 minutes'),
    (49961, p2_id, char2_id, NOW() - INTERVAL '15 minutes')
  ON CONFLICT (conversation_id, user_id, character_id) DO NOTHING;

  INSERT INTO private_messages (id, conversation_id, sender_user_id, sender_character_id, content, created_at, is_deleted)
  VALUES (139611, 49961, p1_id, char1_id, 'Last message preview text', NOW() - INTERVAL '10 minutes', false)
  ON CONFLICT (id) DO UPDATE SET content = EXCLUDED.content;

  RAISE NOTICE 'Created Game #40360: Audience Private Messages fixture (worker 4)';
END $$;
