...
BEGIN
  ...
  player2_id := get_worker_user_id('TestPlayer2', 2);
  player3_id := get_worker_user_id('TestPlayer3', 2);
  ...
  RAISE NOTICE 'Player-to-Audience fixture created: Game #% (worker 2)', game_id;
END $$;

SELECT 'E2E Player-to-Audience fixture (worker 2) created successfully!' AS message;
