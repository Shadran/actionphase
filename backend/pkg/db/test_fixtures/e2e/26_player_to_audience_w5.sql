...
BEGIN
  ...
  player2_id := get_worker_user_id('TestPlayer2', 5);
  player3_id := get_worker_user_id('TestPlayer3', 5);
  ...
  RAISE NOTICE 'Player-to-Audience fixture created: Game #% (worker 5)', game_id;
END $$;

SELECT 'E2E Player-to-Audience fixture (worker 5) created successfully!' AS message;
