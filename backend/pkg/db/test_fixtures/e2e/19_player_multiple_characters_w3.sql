...
-- This is a worker-specific fixture (w3) for parallel E2E testing
--
-- Game #30340: Player Multiple Characters Test
...
BEGIN
  ...
  -- GAME #30340: Player Multiple Characters Test
  -- ============================================
  DELETE FROM games WHERE id = 30340;
  ...
  INSERT INTO messages (
    ...
    (SELECT id FROM characters c WHERE c.game_id = 30340 AND c.user_id IS NULL LIMIT 1),
    'Character Selector Test Post',
    'post', 'game', '{}',
    NOW() - INTERVAL '1 hour'
  );

  RAISE NOTICE 'Player Multiple Characters fixture created: Game #30340 with Player1_3 having 2 characters (Aria Moonwhisper, Kael Shadowblade)';
