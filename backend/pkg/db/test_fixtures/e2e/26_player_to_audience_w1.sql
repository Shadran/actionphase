...
BEGIN
  ...
  player2_id := get_worker_user_id('TestPlayer2', 1);
  player3_id := get_worker_user_id('TestPlayer3', 1);
  ...
  RAISE NOTICE 'Player-to-Audience fixture created: Game #% (worker 1)', game_id;
END $$;

SELECT 'E2E Player-to-Audience fixture (worker 1) created successfully!' AS message;
