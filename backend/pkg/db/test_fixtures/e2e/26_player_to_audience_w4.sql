...
BEGIN
  ...
  player2_id := get_worker_user_id('TestPlayer2', 4);
  player3_id := get_worker_user_id('TestPlayer3', 4);
  ...
  RAISE NOTICE 'Player-to-Audience fixture created: Game #% (worker 4)', game_id;
END $$;

SELECT 'E2E Player-to-Audience fixture (worker 4) created successfully!' AS message;
